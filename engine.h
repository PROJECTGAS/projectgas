...
//то же, что и step, но стенка nowall замыкается на противоположную
//молекулы сталкиваясь с nowall, появляются у противоположной стенки
